...
try{	
   ...
   DISTINCT ON (feature.id) feature.id, feature.geom, feature.name, feature.type, ST_Distance(feature.geom, location, true)  as dist
FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.schools_post_sec_point As feature
