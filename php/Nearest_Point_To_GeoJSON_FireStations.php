...
try{	
   ...
   DISTINCT ON (feature.id) feature.id, feature.geom, feature.name, feature.address, feature.community, ST_Distance(feature.geom, location, true)  as dist
FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.emergency_fire_stations_point As feature
