...
try{	
   ...
   DISTINCT ON (feature.id) feature.id, feature.geom, feature.tradename, feature.address, feature.licencetyp, ST_Distance(feature.geom, location, true)  as dist
FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.business_malls_markets_point As feature
ORDER BY feature.id, ST_Distance(feature.geom, location) ) As query
ORDER BY query.dist LIMIT 3";
