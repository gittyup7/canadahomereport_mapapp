...
try{	
   ...
   DISTINCT ON (feature.id) feature.id, feature.geom, feature.type, feature.name, feature.address, feature.comm_code, ST_Distance(feature.geom, location, true)  as dist
FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.com_services_libraries_point As feature
