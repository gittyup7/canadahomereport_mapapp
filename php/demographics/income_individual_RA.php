...
try{	
	...
	$sql = "SELECT ST_AsGeoJSON(comm.geom, 5) As geojson, comm.name, COALESCE(stats.income::varchar(20), 'Not Available') AS income FROM layers.com_community_boundaries_polygon AS comm LEFT OUTER JOIN layers.com_individual_income_stats AS stats ON (comm.name = stats.community)";
