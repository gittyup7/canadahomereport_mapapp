...
try{	
	...
	$sql = "SELECT geom, tradename, address, business_restaurants_point.licencetyp, comdistnm, ST_AsGeoJSON(geom, 5) As geojson FROM layers.business_restaurants_point";
