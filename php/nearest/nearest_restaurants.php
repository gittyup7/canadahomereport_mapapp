...
try{	
	...
	$sql = 'SELECT tradename, address, licencetyp, comdistnm, ST_Distance(geom, location, true)  as distance FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.business_restaurants_point
