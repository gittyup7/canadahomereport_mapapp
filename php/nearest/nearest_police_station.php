...
try{	
	...
	$sql = 'SELECT name, address, station_ty, community, ST_Distance(geom, location, true)  as distance FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.emergency_police_stations_point
