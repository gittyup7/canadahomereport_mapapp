...
try{	
	...
	$sql = 'SELECT name, address, type, community, ST_Distance(geom, location, true)  as distance FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.entertainment_attractions_point
