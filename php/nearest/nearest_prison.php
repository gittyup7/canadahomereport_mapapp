...
try{	
	...
	$sql = 'SELECT name, capacity, community, ST_Distance(geom, location, true)  as distance FROM ST_SetSRID( ST_Point(:longitude, :latitude), 4326) As location, layers.emergency_hospitals_point
